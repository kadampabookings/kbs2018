...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.resource.spi.impl.gwt.GwtResourceBundle": return new ServiceLoader<S>(kbs2018.frontoffice.application.gwt.embed.EmbedResourcesBundle.ProvidedGwtResourceBundle::new);
            ...
            case "dev.webfx.stack.routing.uirouter.UiRoute": return new ServiceLoader<S>(one.modality.base.frontoffice.activities.account.AccountFriendsAndFamilyEditUiRoute::new, one.modality.base.frontoffice.activities.account.AccountFriendsAndFamilyUiRoute::new, one.modality.base.frontoffice.activities.account.AccountPersonalInformationUiRoute::new, one.modality.base.frontoffice.activities.account.AccountSettingsUiRoute::new, one.modality.base.frontoffice.activities.account.AccountUiRoute::new, one.modality.base.frontoffice.activities.alerts.AlertsUiRoute::new, one.modality.crm.client.activities.login.LoginUiRoute::new, one.modality.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, one.modality.event.frontoffice.activities.booking.BookingUiRoute::new, org.kadampabookings.kbs3.frontoffice.activities.home.HomeUiRoute::new);
            case "dev.webfx.stack.routing.uirouter.operations.RouteRequestEmitter": return new ServiceLoader<S>(one.modality.base.frontoffice.activities.account.RouteToAccountFriendsAndFamilyEditEmitter::new, one.modality.base.frontoffice.activities.account.RouteToAccountFriendsAndFamilyEmitter::new, one.modality.base.frontoffice.activities.account.RouteToAccountPersonalInformationEmitter::new, one.modality.base.frontoffice.activities.account.RouteToAccountRequestEmitter::new, one.modality.base.frontoffice.activities.account.RouteToAccountSettingsRequestEmitter::new, one.modality.base.frontoffice.activities.alerts.RouteToAlertsRequestEmitter::new, one.modality.event.frontoffice.activities.booking.RouteToBookingRequestEmitter::new, org.kadampabookings.kbs3.frontoffice.activities.home.RouteToHomeRequestEmitter::new);
            ...
            case "javafx.application.Application": return new ServiceLoader<S>(org.kadampabookings.kbs2018.frontoffice.KBSFrontOfficeApplication::new);
