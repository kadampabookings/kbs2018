...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.stack.com.serial.spi.SerialCodec": return new ServiceLoader<S>(dev.webfx.stack.authn.serial.UserClaimsSerialCodec::new, dev.webfx.stack.authn.serial.UsernamePasswordCredentialsSerialCodec::new, dev.webfx.stack.com.bus.call.BusCallArgument.ProvidedSerialCodec::new, dev.webfx.stack.com.bus.call.BusCallResult.ProvidedSerialCodec::new, dev.webfx.stack.com.bus.call.SerializableAsyncResult.ProvidedSerialCodec::new, dev.webfx.stack.com.serial.spi.impl.ProvidedBatchSerialCodec::new, dev.webfx.stack.db.datascope.aggregate.AggregateScope.ProvidedSerialCodec::new, dev.webfx.stack.db.query.buscall.serial.QueryArgumentSerialCodec::new, dev.webfx.stack.db.query.buscall.serial.QueryResultSerialCodec::new, dev.webfx.stack.db.querypush.buscall.serial.QueryPushArgumentSerialCodec::new, dev.webfx.stack.db.querypush.buscall.serial.QueryPushResultSerialCodec::new, dev.webfx.stack.db.querypush.buscall.serial.QueryResultTranslationSerialCodec::new, dev.webfx.stack.db.submit.buscall.serial.GeneratedKeyBatchIndexSerialCodec::new, dev.webfx.stack.db.submit.buscall.serial.SubmitArgumentSerialCodec::new, dev.webfx.stack.db.submit.buscall.serial.SubmitResultSerialCodec::new, one.modality.crm.shared.services.authn.serial.ModalityUserPrincipalSerialCodec::new);
            ...
            case "dev.webfx.stack.routing.uirouter.UiRoute": return new ServiceLoader<S>(org.kadampabookings.kbsx.ecommerce.frontoffice.activities.cart.CartUiRoute::new, org.kadampabookings.kbsx.ecommerce.frontoffice.activities.contactus.ContactUsUiRoute::new, org.kadampabookings.kbsx.ecommerce.frontoffice.activities.payment.PaymentUiRoute::new, org.kadampabookings.kbsx.ecommerce.frontoffice.activities.person.PersonUiRoute::new, org.kadampabookings.kbsx.ecommerce.frontoffice.activities.summary.SummaryUiRoute::new, org.kadampabookings.kbsx.event.frontoffice.activities.fees.FeesUiRoute::new, org.kadampabookings.kbsx.event.frontoffice.activities.options.OptionsUiRoute::new, org.kadampabookings.kbsx.event.frontoffice.activities.program.ProgramUiRoute::new, org.kadampabookings.kbsx.event.frontoffice.activities.startbooking.StartBookingUiRoute::new, org.kadampabookings.kbsx.event.frontoffice.activities.terms.TermsUiRoute::new);
            ...
            case "one.modality.base.backoffice.activities.mainframe.headernode.MainFrameHeaderNodeProvider": return new ServiceLoader<S>();
