package org.kadampabookings.kbs2018.hotel.shared.businessdata.time;
...
public final class TimeInterval {
    ...
    public long getIncludedStart(TimeUnit timeUnit) {
        return TimeConverter.convertTime(includedStart, this.timeUnit, timeUnit);
    }

    public long getExcludedEnd(TimeUnit timeUnit) {
        return TimeConverter.convertExcludedEnd(excludedEnd, this.timeUnit, timeUnit);
    }
    ...
    public String getStartText(String format) {
        return TimeConverter.formatTime(getIncludedStart(), timeUnit, false, format);
    }
    ...
    public String getEndText(String format) {
        return TimeConverter.formatTime(getExcludedEnd(), timeUnit, true, format);
    }
